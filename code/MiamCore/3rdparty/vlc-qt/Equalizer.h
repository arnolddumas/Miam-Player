...
public:
    ...
    */
     ...
     */
    qreal amplificationForBandAt(uint bandIndex) const;
     ...
     */
    qreal bandFrequency(uint bandIndex) const;

    /*!
	\brief Get the current pre-amplification value from an equalizer.
	\return preamp value (Hz)
     */
    qreal preamplification() const;
...
public slots:
     ...
     */
    void setAmplificationForBandAt(qreal amp, uint bandIndex);
     ...
     */
    void setPreamplification(qreal value);
